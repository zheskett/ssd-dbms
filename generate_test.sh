...
time_string_1="time split false test1 fill 1000000 0;test2 fill 1000000 0;test3 fill 1000000 0\n"
time_string_2="time split true test4 fill 1000000 0;test5 fill 1000000 0;test6 fill 1000000 0\n"
exit_string="exit\n"
